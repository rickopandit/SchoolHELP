                    ...
                    <div class="container">
                        <div class="card my-5 p-3">
                            <div class="card-heading ">
                                ...
                                <h2 class="card-title text-center">School Admin</h2>
                            </div>
                            <div class="card-body ">
                                <div class="justify-content-center">
                                    <div class="col-auto">
                                        <div class="table-responsive">
                                            ...
                                            $query = mysqli_query($connection, "SELECT * from schooladmin_table");
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="d-flex"><a href="delete_data.php?id=<?= $data['id']; ?>&table=user_table" class="btn btn-sm btn-danger">Delete</a></td>
                                                        </tr>
                                                    <?php
                                                    endforeach;
                                                    ?>
                                        ...
                                        <nav aria-label="...">
                                            <div class="col text-center"><a href="schoolhelp_addadmin.php" class="btn btn-primary mb-4">Add School Admin</a></div>
