<?php
  ...
  {
    if($_SESSION['levelakun']=="tester")
    {
      header('dashboard_tester.php');
    }
...
<div id="wrapper" class="d-flex">
    ...
    <div class=" border-right " id="sidebar-wrapper">
        ...
        <a href="dashboard_tester.php" class="list-group-item list-group-item-action text-center ">Dashboard</a>
        ...
        <div class="container-fluid">
            <div class="card my-5 p-3">
                <div class="card-heading ">
                    ...
                    <h2 class="card-title text-center">Choose Menu</h2>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                          <div class="card bg-blue">
                            <div class="card-body">
                             <h5 class="card-title"><i class="fa fa-address-card"></i> Test Data</h5>
                              <p class="card-text text-secondary">For add and display all test data.</p>
                              <a href="test_data.php" class="btn btn-primary">Go to</a>
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="card bg-blue">
                            <div class="card-body">
                              <h5 class="card-title"><i class="fa fa-file-text "></i> Test Report</h5>
                              <p class="card-text text-secondary">For Display all Test Report.</p>
                              <a href="test_report.php" class="btn btn-primary">Go to</a>
                            </div>
                          </div>
                        </div>
                    </div>
