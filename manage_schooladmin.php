        ...
        <div class="container">
            <div class="card my-5 p-3">
                <div class="card-heading ">
                    ...
                    <h2 class="card-title text-center">School Administrator</h2>
                </div>
                <div class="card-body ">
                    <a href="register_schooladmin.php" class="btn btn-primary mb-4">Add new Admin</a>
                    <div class="justify-content-center">
                        <div class="col-auto"> 
                            ...
                            <?php
                                include "koneksi.php";
                                //$query = mysqli_query($koneksi,"SELECT * from tbuser WHERE levelakun = 'tester'");
                                $query = mysqli_query($koneksi,"SELECT * from schooladmin_tb ");
                            ?>
                                <table class="table table-hover justify-content-center mx-auto border">
                                    ...
                                    ?>
                                    <tr>
                                        <th scope="row"><?php echo $data["staffID"];?></th>
                                        ...
                                        <td><?php echo $data["schoolname"];?></td>
                                        <td class="d-flex"><a href="update_tester.php?id=<?=$data['id'];?>" class="btn btn-sm btn-primary mr-1">Update</a><a href="delete_data.php?id=<?=$data['id'];?>&table=schooladmin_tb" class="btn btn-sm btn-danger">Delete</a></td>
                                    </tr>
                                    <?php  
                                        endforeach;
                                    ?>
