    ...
    <div id="page-content-wrapper">
        <div class="container">
            <div class="card my-5 p-3">
                ...
                <div class="card-body ">
                    <a href="add_test_data.php" class="btn btn-primary mb-4">Add test data</a>
                    <div class="justify-content-center">
                        <div class="col-auto"> 
                            ...
                            <?php
                                include "koneksi.php";
                                $query = mysqli_query($koneksi,"SELECT * from tbtestreport");
                            ...
                            ?>
                                <table class="table table-hover justify-content-center mx-auto border">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $data["patienttype"];?></td>
                                        <td><?php echo $data["symptoms"];?></td>
                                        <td><?php echo $data["result"];?></td>
                                        <td><?php echo $data["status"];?></td>
                                        <td><?php echo $data["testcentrename"];?></td>
                                        <td class="d-flex"><a href="update_test.php?id=<?=$data['id'];?>" class="btn btn-sm btn-primary mr-1">Update</a><a href="delete_data.php?id=<?=$data['id'];?>&table=tbtestreport" class="btn btn-sm btn-danger">Delete</a></td>
                                    </tr>
                                    </tbody>
                                    <?php  
                                        $data++;}
