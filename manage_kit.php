                ...
                <div class="card-body ">
                    ...
                    <div class="justify-content-center">
                        <div class="col-auto"> 
                            ...
                            <?php
                                include "koneksi.php";
                                $query = mysqli_query($koneksi,"SELECT * from tbtestkit");
                            ...
                            ?>
                                <table class="table table-hover justify-content-center mx-auto border">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $data["testkitname"];?></td>
                                        <td><?php echo $data["stock"];?></td>
                                        <td><?php echo $data["testcentrename"];?></td>
                                        <td class="d-flex"><a href="update_kit.php?id=<?=$data['id'];?>" class="btn btn-sm btn-primary mr-1">Update</a><a href="delete_data.php?id=<?=$data['id'];?>&table=tbtestkit" class="btn btn-sm btn-danger">Delete</a></td>
                                    </tr>
