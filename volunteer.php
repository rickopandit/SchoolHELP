        ...
        <div class="container">
            <div class="card my-5 p-3">
                <div class="card-heading ">
                    ...
                    <h2 class="card-title text-center">Volunteer Information</h2>
                </div>
                <div class="card-body ">
                    ...
                    <div class="justify-content-center">
                        <div class="col-auto"> 
                            ...
                            <?php
                                include "koneksi.php";
                                $query = mysqli_query($koneksi,"SELECT * from volunteer_db");
                            ...
                            ?>
                                <table class="table table-hover justify-content-center mx-auto border">
                                    ...
                                    <th scope="row"><?php echo $data["id"];?></th>
                                        ...
                                        <td class="d-flex"><a href="delete_data.php?id=<?=$data['id'];?>&table=volunteer_db" class="btn btn-sm btn-danger">Remove</a></td>
                                    </th>
                                    </tbody>
                                    <?php  
                                        $data++;}
