                    ...
                    <div class="container">
                        <div class="card my-5 p-3">
                            <div class="card-heading ">
                                ...
                                <h2 class="card-title text-center">School List</h2>
                            </div>
                            <div class="card-body ">
                                <div class="justify-content-center">
                                    <div class="col-auto">
                                        <div class="table-responsive">
                                            ...
                                            $query = mysqli_query($connection, "SELECT * from school_table");
                                                ...
                                                ?>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $data["school_address"]; ?></td>
                                                            <td><?php echo $data["school_city"]; ?></td>
                                                            <td class="d-flex"><a href="delete_data.php?id=<?= $data['id']; ?>&table=school_table" class="btn btn-sm btn-danger">Delete</a></td>
                                                        </tr>
                                                    </tbody>
                                                <?php
                                        ...
                                        <nav aria-label="...">
                                            <div class="col text-center"><a href="schoolhelp_addschool.php" class="btn btn-primary mb-4 mx-7 ">Register School</a></div>
