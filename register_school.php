        ...
        <div class="container">
            <div class="card my-5 p-3">
                <div class="card-heading ">
                    ...
                    <h2 class="card-title text-center">Add New School</h2>
                </div>
                <div class="card-body">
                    <form action="recordschool.php" method="post">
                          <div class="form-group">
                            <label for="name">School Name</label>
                            <input type="text" name="schoolname" class="form-control" id="name" placeholder="Enter school name" required>
                          </div>
                          <div class="form-group">
                            <label for="name">School Address</label>
                            <input type="text" name="schooladdress" class="form-control" id="name" placeholder="Enter school name" required>
                          </div>
                          <div class="form-group">
                            <label for="name">School City</label>
                            <input type="text" name="schoolcity" class="form-control" id="name" placeholder="Enter school city" required>
                          </div>
