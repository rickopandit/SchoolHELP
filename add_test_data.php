...
$row = mysqli_query($koneksi,"SELECT * FROM tbuser where levelakun='patient'");
        ...
        <div class="container">
            <div class="card my-5 p-3">
                <div class="card-heading ">
                    ...
                    <h2 class="card-title text-center">Add new test data</h2>
                </div>
                <div class="card-body">
                    <a href="add_patient.php" class="btn btn-primary mb-3">Add new patient</a>
                    <form action="addTestData.php" method="post">
                        <div class="form-group">
                            <label for="test_centre">Patient Name</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="symptoms" aria-describedby="symptoms" placeholder="Symptoms" required>
                        </div>
                        <div class="form-group">
