...
{
    $id = $_GET['id'];
    $query = mysqli_query($koneksi,"SELECT * FROM school_db WHERE id= $id");
        ...
        <div class="container">
            <div class="card my-5 p-3">
                <div class="card-heading ">
                    ...
                    <h2 class="card-title text-center">Update School Data</h2>
                </div>
                <div class="card-body">
                    <form action="updateSchool.php?id=<?=$id;?>" method="post">
                        <div class="form-group">
                            <label for="name">School Name</label>
                            <input type="text" name="schoolname" class="form-control" value="<?=$row['schoolname']?>" required>
                        </div>
                        <div class="form-group">
                            <label for="name">School Address</label>
                            <input type="text" name="schooladdress" class="form-control" value="<?=$row['schooladdress']?>" required>
                        </div>
                        <div class="form-group">
                            <label for="name">School City</label>
                            <input type="text" name="schoolcity" class="form-control" value="<?=$row['schoolcity']?>" required>
                        </div>
