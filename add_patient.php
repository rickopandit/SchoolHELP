...
<div id="wrapper" class="d-flex">
    ...
    <div class=" border-right" id="sidebar-wrapper">
        ...
        <a href="logout" class="list-group-item list-group-item-action text-center">Logout</a>
        </div>
    </div>
    <!-- /#sidebar-wrapper -->
    ...
    <div id="page-content-wrapper">
        <div class="container">
            <div class="card my-5 p-3">
                ...
                <div class="card-body">
                    <h2 class="text-center">Add new patient data</h2>
                    <form action="prosesrecordpatient.php" method="post">
                        ...
                        <div class="form-group">
                            <label for="test_centre">Patient Type</label>
