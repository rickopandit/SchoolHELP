                                ...
                                <div class="col-lg">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Register School</h1>
                                            <hr>
                                        </div>
                                        <form class="user" method="post" action="query_sha_addschool.php">

                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-user" id="fullname" name="school_name" placeholder="School's Name">

                                            </div>
                                            
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-user" id="fullname" name="school_address" placeholder="School Address">

                                            </div>
                                            
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-user" id="fullname" name="school_city" placeholder="School City">
