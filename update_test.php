        ...
        <div class="container">
            <div class="card my-5 p-3">
                <div class="card-heading ">
                    ...
                    <h2 class="card-title text-center">Update Test Data</h2>
                </div>
                <div class="card-body">
                    <form action="updateTest.php?id=<?=$id;?>" method="post">
                        <div class="form-group">
                            <label for="name">Result</label>
                            <textarea class="form-control" name="result" aria-describedby="result" placeholder="Result" style="height:270px" required></textarea>
                        </div>
                        <div class="form-group">
                            <label for="test_centre">Status</label>
