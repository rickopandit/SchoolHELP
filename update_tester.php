...
include 'koneksi.php';
$testcentre = mysqli_query($koneksi,"SELECT * FROM tbtestcentre ");
        ...
        <div class="container">
            <div class="card my-5 p-3">
                <div class="card-heading ">
                    ...
                    <h2 class="card-title text-center">Update Tester</h2>
                </div>
                <div class="card-body">
                    <form action="updateTester.php?id=<?=$id;?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="exampleFormControlSelect1" name="testcentrename" >
                            <?php foreach($testcentre as $r): 
                                $centre =  $r['testcentrename'];
                                ?>
                                <option value="<?= $r['testcentrename']; ?>"  <?php echo ($centre==  $row['testcentrename']) ? ' selected="selected"' : '';?>><?= $r['testcentrename']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
