                                    ...
                                    <div class="col-auto">
                                        ...
                                        <?php
                                            ...
                                            if (isset($_GET['id'])) {
                                                ...
                                                $query = mysqli_query($connection, "SELECT * FROM offer_table WHERE req_id = $id");
                                                ?>
                                                <thead>
                                                    <tr>
                                                    ...
                                                    while ($data = mysqli_fetch_assoc($query)) {
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $data['offerStatus']; ?></td>
                                                                <td class="d-flex"><a href="query_sa_reviewoffer.php?id=<?= $data['id']; ?>" class="btn btn-sm btn-success mr-1">Accept Offer</a></td>
